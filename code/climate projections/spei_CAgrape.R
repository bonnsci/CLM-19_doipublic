...
# load data
dat <- read.csv("data/large_data/clm_vin.csv")
...
# write.csv(speidat, "data/climate data not large/spei_grape.csv", row.names=F)
...
# climate - SPEI
spei <- read.csv("data/climate data not large/spei_grape.csv")
...
write.csv(spei, "data/climate data not large/spei_grape_formerge.csv", row.names = F)
