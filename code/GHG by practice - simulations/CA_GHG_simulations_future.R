...
# 1         site_name
# 2       region_name
# 3         crop_name # we have almonds and grapes together here
...
# -0.49563 -0.09369 -0.02905  0.06696  2.11922 
# 
# Coefficients: (1 not defined because of singularities)
# Estimate Std. Error t value Pr(>|t|)    
# (Intercept)            0.425399   0.007343  57.932   <2e-16 ***
#   tillCT:ccLC:nfert40 N  0.149528   0.010385  14.399   <2e-16 ***
#   tillNT:ccLC:nfert40 N -0.146418   0.010385 -14.099   <2e-16 ***
#   tillRT:ccLC:nfert40 N  0.168679   0.010385  16.243   <2e-16 ***
#   tillCT:ccNC:nfert40 N -0.141776   0.010385 -13.652   <2e-16 ***
#   tillNT:ccNC:nfert40 N -0.141584   0.010385 -13.634   <2e-16 ***
#   tillRT:ccNC:nfert40 N -0.142776   0.010385 -13.749   <2e-16 ***
#   tillCT:ccTC:nfert40 N -0.157534   0.010385 -15.170   <2e-16 ***
#   tillNT:ccTC:nfert40 N -0.146418   0.010385 -14.099   <2e-16 ***
#   tillRT:ccTC:nfert40 N -0.153558   0.010385 -14.787   <2e-16 ***
#   tillCT:ccLC:nfert50 N  0.303086   0.010385  29.186   <2e-16 ***
#   tillNT:ccLC:nfert50 N  0.007140   0.010385   0.688    0.492    
# tillRT:ccLC:nfert50 N  0.322237   0.010385  31.030   <2e-16 ***
#   tillCT:ccNC:nfert50 N  0.011782   0.010385   1.135    0.257    
# tillNT:ccNC:nfert50 N  0.011974   0.010385   1.153    0.249    
# tillRT:ccNC:nfert50 N  0.010782   0.010385   1.038    0.299    
# tillCT:ccTC:nfert50 N -0.003976   0.010385  -0.383    0.702    
# tillNT:ccTC:nfert50 N  0.007140   0.010385   0.688    0.492    
# tillRT:ccTC:nfert50 N        NA         NA      NA       NA    
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# Residual standard error: 0.2098 on 14670 degrees of freedom
# Multiple R-squared:  0.3351,	Adjusted R-squared:  0.3344 
# F-statistic:   435 on 17 and 14670 DF,  p-value: < 2.2e-16
# 
# > summary(lmsoc)
# 
# Call:
...
# Residuals:
#   Min      1Q  Median      3Q     Max 
# -4.1517 -0.1966 -0.0160  0.2174  2.2741 
# 
# Coefficients: (1 not defined because of singularities)
# Estimate Std. Error t value Pr(>|t|)    
# (Intercept)           -0.27836    0.01762 -15.795  < 2e-16 ***
#   tillCT:ccLC:nfert40 N -0.62539    0.02492 -25.093  < 2e-16 ***
#   tillNT:ccLC:nfert40 N  0.07908    0.02492   3.173  0.00151 ** 
#   tillRT:ccLC:nfert40 N -0.71846    0.02492 -28.827  < 2e-16 ***
#   tillCT:ccNC:nfert40 N  0.23466    0.02492   9.415  < 2e-16 ***
#   tillNT:ccNC:nfert40 N  0.21301    0.02492   8.547  < 2e-16 ***
#   tillRT:ccNC:nfert40 N  0.21804    0.02492   8.749  < 2e-16 ***
#   tillCT:ccTC:nfert40 N  0.02771    0.02492   1.112  0.26624    
# tillNT:ccTC:nfert40 N  0.07908    0.02492   3.173  0.00151 ** 
#   tillRT:ccTC:nfert40 N  0.04826    0.02492   1.936  0.05283 .  
# tillCT:ccLC:nfert50 N -0.67365    0.02492 -27.029  < 2e-16 ***
#   tillNT:ccLC:nfert50 N  0.03082    0.02492   1.237  0.21621    
# tillRT:ccLC:nfert50 N -0.76672    0.02492 -30.764  < 2e-16 ***
#   tillCT:ccNC:nfert50 N  0.18639    0.02492   7.479 7.92e-14 ***
#   tillNT:ccNC:nfert50 N  0.16475    0.02492   6.610 3.97e-11 ***
#   tillRT:ccNC:nfert50 N  0.16978    0.02492   6.812 9.99e-12 ***
#   tillCT:ccTC:nfert50 N -0.02055    0.02492  -0.825  0.40957    
# tillNT:ccTC:nfert50 N  0.03082    0.02492   1.237  0.21621    
# tillRT:ccTC:nfert50 N       NA         NA      NA       NA    
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# Residual standard error: 0.5034 on 14670 degrees of freedom
# Multiple R-squared:  0.3164,	Adjusted R-squared:  0.3156 
# F-statistic: 399.3 on 17 and 14670 DF,  p-value: < 2.2e-16
# 
# > summary(lmnet)
# 
# Call:
...
# Residuals:
#   Min      1Q  Median      3Q     Max 
# -3.8938 -0.2458 -0.0203  0.2605  3.7320 
# 
# Coefficients: (1 not defined because of singularities)
# Estimate Std. Error t value Pr(>|t|)    
# (Intercept)            0.14213    0.01860   7.642 2.27e-14 ***
#   tillCT:ccLC:nfert40 N -0.48226    0.02630 -18.335  < 2e-16 ***
#   tillNT:ccLC:nfert40 N -0.06703    0.02630  -2.548  0.01083 *  
#   tillRT:ccLC:nfert40 N -0.55734    0.02630 -21.190  < 2e-16 ***
#   tillCT:ccNC:nfert40 N  0.09406    0.02630   3.576  0.00035 ***
#   tillNT:ccNC:nfert40 N  0.07238    0.02630   2.752  0.00593 ** 
#   tillRT:ccNC:nfert40 N  0.07633    0.02630   2.902  0.00371 ** 
#   tillCT:ccTC:nfert40 N -0.12965    0.02630  -4.929 8.34e-07 ***
#   tillNT:ccTC:nfert40 N -0.06703    0.02630  -2.548  0.01083 *  
#   tillRT:ccTC:nfert40 N -0.10509    0.02630  -3.996 6.48e-05 ***
#   tillCT:ccLC:nfert50 N -0.37716    0.02630 -14.340  < 2e-16 ***
#   tillNT:ccLC:nfert50 N  0.03806    0.02630   1.447  0.14786    
# tillRT:ccLC:nfert50 N -0.45225    0.02630 -17.194  < 2e-16 ***
#   tillCT:ccNC:nfert50 N  0.19916    0.02630   7.572 3.90e-14 ***
#   tillNT:ccNC:nfert50 N  0.17748    0.02630   6.748 1.56e-11 ***
#   tillRT:ccNC:nfert50 N  0.18142    0.02630   6.898 5.50e-12 ***
#   tillCT:ccTC:nfert50 N -0.02456    0.02630  -0.934  0.35052    
# tillNT:ccTC:nfert50 N  0.03806    0.02630   1.447  0.14786    
# tillRT:ccTC:nfert50 N       NA         NA      NA       NA    
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# Residual standard error: 0.5313 on 14670 degrees of freedom
# Multiple R-squared:  0.1574,	Adjusted R-squared:  0.1564 
# F-statistic: 161.2 on 17 and 14670 DF,  p-value: < 2.2e-16
...
# till:cc:nfert    17  325.4  19.139     435 <2e-16 ***
#   Residuals     14670  645.5   0.044                   
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

summary(aovsoc)
# Df Sum Sq Mean Sq F value Pr(>F)    
# till:cc:nfert    17   1720  101.20   399.3 <2e-16 ***
#   Residuals     14670   3718    0.25                   
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

summary(aovnet)
# Df Sum Sq Mean Sq F value Pr(>F)    
# till:cc:nfert    17    773   45.49   161.2 <2e-16 ***
#   Residuals     14670   4141    0.28                   
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
...
ggsave("plots/ghgs/CA_decadal mean net em RCP60_with letters.png", width=8, height=6, dpi=300)
...
ggsave("plots/ghgs/CA_mean 2022-2072 em RCP60_with letters.png", width=6, height=7, dpi=300)
