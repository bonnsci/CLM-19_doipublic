...
# load data
ghgdat <- read.csv("data/simulations/un-weighted_resultsPNW.csv")
...
# -0.29289 -0.13817 -0.03492  0.12065  0.72812 
# 
# Coefficients: (1 not defined because of singularities)
# Estimate Std. Error t value Pr(>|t|)    
# (Intercept)                      0.378322   0.005841  64.771  < 2e-16 ***
#   tillCT:ccCC:nfertConventional N -0.111429   0.008260 -13.490  < 2e-16 ***
#   tillNT:ccCC:nfertConventional N -0.109812   0.008260 -13.294  < 2e-16 ***
#   tillRT:ccCC:nfertConventional N -0.117406   0.008260 -14.213  < 2e-16 ***
#   tillCT:ccNC:nfertConventional N -0.041828   0.008260  -5.064 4.19e-07 ***
#   tillNT:ccNC:nfertConventional N -0.048663   0.008260  -5.891 3.96e-09 ***
#   tillRT:ccNC:nfertConventional N -0.047578   0.008260  -5.760 8.67e-09 ***
#   tillCT:ccCC:nfertOrganic N      -0.063852   0.008260  -7.730 1.18e-14 ***
#   tillNT:ccCC:nfertOrganic N      -0.062234   0.008260  -7.534 5.35e-14 ***
#   tillRT:ccCC:nfertOrganic N      -0.069828   0.008260  -8.454  < 2e-16 ***
#   tillCT:ccNC:nfertOrganic N       0.005750   0.008260   0.696    0.486    
# tillNT:ccNC:nfertOrganic N      -0.001086   0.008260  -0.131    0.895    
# tillRT:ccNC:nfertOrganic N             NA         NA      NA       NA    
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# Residual standard error: 0.1668 on 9780 degrees of freedom
# Multiple R-squared:  0.0574,	Adjusted R-squared:  0.05634 
# F-statistic: 54.15 on 11 and 9780 DF,  p-value: < 2.2e-16
# 
# > summary(lmsoc)
# 
# Call:
...
# Residuals:
#   Min      1Q  Median      3Q     Max 
# -0.8004 -0.4777 -0.1307  0.4595  2.1181 
# 
# Coefficients: (1 not defined because of singularities)
# Estimate Std. Error t value Pr(>|t|)    
# (Intercept)                      0.56293    0.01930  29.172  < 2e-16 ***
#   tillCT:ccCC:nfertConventional N -0.04469    0.02729  -1.638   0.1016    
# tillNT:ccCC:nfertConventional N -0.12991    0.02729  -4.760 1.96e-06 ***
#   tillRT:ccCC:nfertConventional N -0.13739    0.02729  -5.034 4.88e-07 ***
#   tillCT:ccNC:nfertConventional N  0.35515    0.02729  13.014  < 2e-16 ***
#   tillNT:ccNC:nfertConventional N  0.24025    0.02729   8.804  < 2e-16 ***
#   tillRT:ccNC:nfertConventional N  0.26795    0.02729   9.819  < 2e-16 ***
#   tillCT:ccCC:nfertOrganic N      -0.31264    0.02729 -11.456  < 2e-16 ***
#   tillNT:ccCC:nfertOrganic N      -0.39786    0.02729 -14.579  < 2e-16 ***
#   tillRT:ccCC:nfertOrganic N      -0.40534    0.02729 -14.853  < 2e-16 ***
#   tillCT:ccNC:nfertOrganic N       0.08720    0.02729   3.195   0.0014 ** 
#   tillNT:ccNC:nfertOrganic N      -0.02770    0.02729  -1.015   0.3101    
# tillRT:ccNC:nfertOrganic N            NA         NA      NA       NA    
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# Residual standard error: 0.5512 on 9780 degrees of freedom
# Multiple R-squared:  0.1614,	Adjusted R-squared:  0.1604 
# F-statistic: 171.1 on 11 and 9780 DF,  p-value: < 2.2e-16
# 
# > summary(lmnet)
# 
# Call:
...
# Residuals:
#   Min      1Q  Median      3Q     Max 
# -1.0301 -0.5894 -0.1631  0.5819  2.7877 
# 
# Coefficients: (1 not defined because of singularities)
# Estimate Std. Error t value Pr(>|t|)    
# (Intercept)                      0.92131    0.02401  38.374  < 2e-16 ***
#   tillCT:ccCC:nfertConventional N -0.15898    0.03395  -4.682 2.87e-06 ***
#   tillNT:ccCC:nfertConventional N -0.24130    0.03395  -7.107 1.27e-12 ***
#   tillRT:ccCC:nfertConventional N -0.25794    0.03395  -7.597 3.31e-14 ***
#   tillCT:ccNC:nfertConventional N  0.31238    0.03395   9.200  < 2e-16 ***
#   tillNT:ccNC:nfertConventional N  0.18956    0.03395   5.583 2.43e-08 ***
#   tillRT:ccNC:nfertConventional N  0.21885    0.03395   6.446 1.20e-10 ***
#   tillCT:ccCC:nfertOrganic N      -0.37784    0.03395 -11.128  < 2e-16 ***
#   tillNT:ccCC:nfertOrganic N      -0.46016    0.03395 -13.553  < 2e-16 ***
#   tillRT:ccCC:nfertOrganic N      -0.47680    0.03395 -14.043  < 2e-16 ***
#   tillCT:ccNC:nfertOrganic N       0.09352    0.03395   2.754  0.00589 ** 
#   tillNT:ccNC:nfertOrganic N      -0.02930    0.03395  -0.863  0.38823    
# tillRT:ccNC:nfertOrganic N            NA         NA      NA       NA    
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# Residual standard error: 0.6858 on 9780 degrees of freedom
# Multiple R-squared:  0.125,	Adjusted R-squared:  0.124 
# F-statistic:   127 on 11 and 9780 DF,  p-value: < 2.2e-16
...
summary(aovsoc)
# Df Sum Sq Mean Sq F value Pr(>F)    
# till:cc:nfert   11  571.9   51.99   171.1 <2e-16 ***
#   Residuals     9780 2971.6    0.30                   
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

summary(aovnet)
# Df Sum Sq Mean Sq F value Pr(>F)    
# till:cc:nfert   11    657   59.74     127 <2e-16 ***
#   Residuals     9780   4600    0.47                   
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
...
# seem to be losing SOC not gaining, let's look at the data distributions:

windows(xpinch=200, ypinch=200, width=5, height=5)
ghgdatl <- pivot_longer(ghgdat, cols=c("ghg", "ghg_dsoc", "ghg_total_n2o"),
                        names_to="var",
                        values_to="co2e")

ggplot(ghgdatl, aes(x=var, y=co2e)) +
  geom_boxplot

ggsave("plots/ghgs/PNW_CO2e_boxplots.png", width=8, height=6, dpi=300)
...
ghgdec <- ghgdat %>%
  group_by(till, cc, nfert, decade) %>%  # calculate annual means and se across sites and years per crop per decade
  ...
  melt(id=c("till", "cc", "nfert", "decade")) %>%  # , "crop"  #melt so that net, dsoc, and n2o are in one column for making stacked bar chart
...
ggplot() +
  ...
  geom_bar(data=ghgdec[ghgdec$var == "ghgn2o",], # need separate call for bars for n2o, for soc, and points for net
  ...
  geom_bar(data=ghgdec[ghgdec$var == "ghgdsoc",],  # need separate call for bars for n2ghgdec$till %in% c("CT", "NT"),], # for AGU only showing CT and NT not RT to simplify a bit
    aes(x=nfert, y=mean, group=decade),  
  ...
  geom_point(data=ghgdec[ghgdec$var == "net",],
             aes(x=nfert, y=mean, group=decade),
...
ggsave("plots/ghgs/PNW_decadal mean net em RCP60_with letters.png", width=8, height=6, dpi=300)
...
ggplot(data=ghgsummary, aes(x=nfert)) +
  ...
  ylab(expression('Mean annual emissions 2022-2072 (tonnes CO'[2]*'e per acre)')) +
...
ggsave("plots/ghgs/PNW_mean 2022-2072 em RCP60_with letters.png", width=6, height=7, dpi=300)
