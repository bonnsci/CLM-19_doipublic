...
ggsave("plots/county_heatmap_ILcc.png")
...
ggsave("plots/county_heatmap_ILnt.png")
...
ggsave("plots/county_heatmap_ILrt.png")
...
ggsave("plots/county_heatmap_ILct.png")
...
ggsave("plots/county_heatmap_ILall4.png")
