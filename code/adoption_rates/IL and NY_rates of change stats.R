...
# survey data for Central IL, Southern IL, and Western NY
...
ccwny <- aov(value~source:crop_name, data=dat.reg[dat.reg$year==2017& dat.reg$variable=="perc_cc" & dat.reg$region=="Western NY",])
summary(ccwny)
...
t1 <- dat.reg[dat.reg$year==2017& dat.reg$variable=="perc_ct" & dat.reg$region=="Central IL",]
...
# AgCensus:Soybeans-AgCensus:Corn             NA         NA        NA        NA
# OpTIS:Soybeans-AgCensus:Corn                NA         NA        NA        NA
# AgCensus:Cropland-OpTIS:Corn        -6.2097939 -10.068542 -2.351046 0.0001320
# OpTIS:Cropland-OpTIS:Corn                   NA         NA        NA        NA
# AgCensus:Soybeans-OpTIS:Corn                NA         NA        NA        NA
# OpTIS:Soybeans-OpTIS:Corn           -0.2735929  -4.132341  3.585155 0.9999473
# OpTIS:Cropland-AgCensus:Cropland            NA         NA        NA        NA
# AgCensus:Soybeans-AgCensus:Cropland         NA         NA        NA        NA
# OpTIS:Soybeans-AgCensus:Cropland     5.9362010   2.077453  9.794949 0.0002939
# AgCensus:Soybeans-OpTIS:Cropland            NA         NA        NA        NA
# OpTIS:Soybeans-OpTIS:Cropland               NA         NA        NA        NA
# OpTIS:Soybeans-AgCensus:Soybeans            NA         NA        NA        NA
...
############## SAME TESTS AS ABOVE BUT FOR 2015, 2018 OPTIS VS TRANSECT

ntcil2 <- aov(value~source:crop_name:factor(year), data=dat.reg[dat.reg$year %in% c(2015, 2018) & dat.reg$variable=="perc_nt" & dat.reg$region=="Central IL",])
summary(ntcil2)
# Df Sum Sq Mean Sq F value Pr(>F)    
...
rtcil2 <- aov(value~source:crop_name:factor(year), data=dat.reg[dat.reg$year %in% c(2015, 2018) & dat.reg$variable=="perc_rt" & dat.reg$region=="Central IL",])
summary(rtcil2)
# Df Sum Sq Mean Sq F value Pr(>F)    
...
ctcil2 <- aov(value~source:crop_name:factor(year), data=dat.reg[dat.reg$year %in% c(2015, 2018) & dat.reg$variable=="perc_ct" & dat.reg$region=="Central IL",])
summary(ctcil2)
# Df Sum Sq Mean Sq F value Pr(>F)    
...
ntsil2 <- aov(value~source:crop_name:factor(year), data=dat.reg[dat.reg$year %in% c(2015, 2018) & dat.reg$variable=="perc_nt" & dat.reg$region=="Southern IL",])
summary(ntsil2)
# Df Sum Sq Mean Sq F value Pr(>F)    
...
rtsil2 <- aov(value~source:crop_name:factor(year), data=dat.reg[dat.reg$year %in% c(2015, 2018) & dat.reg$variable=="perc_rt" & dat.reg$region=="Southern IL",])
summary(rtsil2)
# Df Sum Sq Mean Sq F value Pr(>F)    
...
ctsil2 <- aov(value~source:crop_name:factor(year), data=dat.reg[dat.reg$year %in% c(2015, 2018) & dat.reg$variable=="perc_ct" & dat.reg$region=="Southern IL",])
summary(ctsil2)
# Df Sum Sq Mean Sq F value Pr(>F)    
...
region_sum <- dat.reg %>% group_by(region, year, source, variable) %>%
...
region_sum2 <- left_join(region_sum2, means.17)
