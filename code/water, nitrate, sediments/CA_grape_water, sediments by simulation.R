...
# wdat <- read.csv("data/large_data/daily water, sediments/CA_vineyards_day_water.csv")
# beepr::beep(sound=8)
# # 
...
unique(wdatyr$crop)  # we only have the crop row data now the alley info, meaning we
# don't have cover crop or tillage info because that happens in the alley.
...
################################# left off here adapting the code for grapes 2/7/2024
